...
\textbf{tu powyrzej jest coś grubo nie tak}\\
$\left.
\begin{array}{l}
...
\begin{definition}
$S$ jest minimalnym zbiorem klauzul niespełnialnych, kiedy każdy $S' \subsetneq S$ jest już specialny.
\end{definition}
...
\end{theorem}
$\Rightarrow$ $C_1, \ldots, C_p = \square$, niewprost $f(\square) = true$, sprzeczność.
$\Leftarrow$ \\
